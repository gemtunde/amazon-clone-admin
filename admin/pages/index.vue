  ...
  <div class="container-fluid browsing-history">
      <div class="row">
        <div class="col-sm-8 col-8">
          ...
          <nuxt-link to="/category" class="a-button-history margin-right-10">Add new Category</nuxt-link>
          <nuxt-link to="/owner" class="a-button-history margin-right-10">Add new Owner</nuxt-link>
                <!-- Listing Page -->
        </div>
      </div>
  </div>
      ...
      <div class="history-box">
        ...
        <div class="a-row">
          <span class="a-size-base a-color-price">
            <span class="p13b-sc-price">${{ product.price }}</span>
          </span>
        </div>
        <!-- Product buttons -->
        <div class="a-row">
          <nuxt-link :to="`/products/${product._id}`" href="#" class="a-button-history margin-right-10">Update</nuxt-link>
          <a
          href="#"
...
export default {
  ...
  async asyncData({$axios}){
    try {
      ...
      console.log(response.products.photo)
      return{
   ...
   async onDeleteProduct(id, index){
      try {
        let prodDelete = await $axios.$delete(`http://localhost:3000/api/products/${id}`);
